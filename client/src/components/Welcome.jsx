...
// const _commonStyles =  "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center items-center border-[0.5px] border-gray-400 text-sm font-light text-white";
...
//         <div className="flex mf:flex-row flex-col items-start justtify-between md:p-20 px-4"> 
//             <div className="felx felx-1 justify-start flex-col mf:mr-10">
...
//                 </div>
//             </div>
//             <div className="flex flex-col flex-1 items-center justify-start 2-full mf:mt-0 mt-10">
...
//                         className="text-white w-ful mt-2 border-[1px] p-2 border-[#3d4f7c] rounder-full cursor-pointer"
//                         >
//                             Send Now
//                         </button>
//                     )}
